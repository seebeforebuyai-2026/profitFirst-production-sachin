  ...
  const fetchInsight = async () => {
    try {
      ...
      if (d.syncStatus === "in_progress") {
        setStatus("syncing");
        setTimeout(fetchInsight, 5000); // har 5 sec mein retry
        return;
      }
      ...
      <div style={styles.main}>
        ...
        {status === "loading" && (
          <div style={styles.centerBox}>
            ...
            <h2 style={styles.heading}>Loading Meta data...</h2>
        ...
        {status === "ready" && data && (
          <>
            ...
            <div style={styles.insightCard}>
              ...
              <div style={styles.insightNumbers}>
                <div>
                  ...
                  <p style={styles.numLabel}>Ad spend</p>
                </div>
                <div>
                  <p style={styles.numValue}>{data.roas}</p>
                  <p style={styles.numLabel}>ROAS</p>
                </div>
              </div>
            ...
            <p style={styles.stepText}>— Step 3 of 7</p>
            ...
            <p style={styles.subText}>
              Connect Shiprocket to see shipping costs and RTO losses against
              your ad spend.
            </p>
